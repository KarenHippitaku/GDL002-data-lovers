...
2. El usuario necesita un menú con opciones de filtrado (ej. por año) para visualizar información específica.

    **D.O.D**  
    - Al hacer click, el menú de filtrado debe mostrar las opciones (ej. por año).-
